...
<head>
	<title>Toko Buku Termurah Sejagat</title>
	<meta charset="utf-8">
					...
					<div class="row">
						<div class="col">
							<div class="header_content d-flex flex-row align-items-center justify-content-start">
								<div class="logo"><a href="index.php">Eeyore book store</a></div>
								<nav class="main_nav">
									<ul>
									...
									<div class="col">
										<div class="home_slider_content" data-animation-in="fadeIn" data-animation-out="animate-out fadeOut">
											<div class="home_slider_title">
												<font size="5px">Toko Buku Termurah Sejagat</font> Eeyore.
											</div>
											<div class="home_slider_subtitle">Selamat Datang di Eeyore</div>
				...
				<div class="row icon_box_row">
					...
					<div class="col-lg-4 icon_box_col">
						<div class="icon_box">
							...
							<div class="icon_box_title">Gratis Ongkir Se-Semesta</div>
							<div class="icon_box_text">
								<p>Gratis Ongkir sana sini dimanapun!.</p>
							</div>
						</div>
					</div>
					...
					<div class="col-lg-4 icon_box_col">
						<div class="icon_box">
							...
							<div class="icon_box_text">
								<p>Khawatir buku tidak cocok? Jangan khawatir, karena apapun alasannya retur di Eeyore gratis & mudah!</p>
							</div>
						</div>
					</div>
				...
				<div class="row">
					<div class="col">
						<div class="footer_content d-flex flex-lg-row flex-column align-items-center justify-content-lg-start justify-content-center">
							<div class="footer_logo"><a href="index.php">Eeyore</a></div>
							<div class="copyright ml-auto mr-auto">
								<!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. -->
								Copyright &copy;<script>
									document.write(new Date().getFullYear());
								</script> All rights reserved | Eeyore <br>
